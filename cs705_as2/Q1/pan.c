...
/*** From source: petersons_muetx.pml ***/
...
short src_ln5 [] = {
	  0,  54,  54,  55,  55,  55,  56,  56, 
	 53,  58,  53,  60,  60,  59,  62,  59, 
	 63,  64,   0, };
S_F_MAP src_file5 [] = {
	{ "-", 0, 0 },
	{ "_spin_nvr.tmp", 1, 17 },
...
short src_ln3 [] = {
	  0,  26,  26,  27,  27,  27,  28,  28, 
	 25,  30,  25,  32,  32,  31,  34,  31, 
	 35,  36,   0, };
S_F_MAP src_file3 [] = {
	{ "-", 0, 0 },
	{ "_spin_nvr.tmp", 1, 17 },
...
short src_ln0 [] = {
	  0,   7,   9,  10,  11,  11,  13,  14, 
	 15,  17,  18,  19,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "petersons_muetx.pml", 1, 11 },
	{ "-", 12, 13 }
};
uchar reached0 [] = {
	  0,   0,   0,   0,   0,   1,   0,   0, 
...
#ifndef NOCLAIM
	case 7:	/* claim select */
		spin_c_typ[0] = 5; /* liveness2_pid1 */
		((P7 *)pptr(h))->c_cur[0] = 8;
		reached5[8]=1;
		spin_c_typ[1] = 4; /* liveness2_pid0 */
		((P7 *)pptr(h))->c_cur[1] = 8;
		reached4[8]=1;
		spin_c_typ[2] = 3; /* liveness1_pid1 */
		((P7 *)pptr(h))->c_cur[2] = 8;
		reached3[8]=1;
		spin_c_typ[3] = 2; /* liveness1_pid0 */
		((P7 *)pptr(h))->c_cur[3] = 8;
		reached2[8]=1;
		spin_c_typ[4] = 1; /* safety */
		((P7 *)pptr(h))->c_cur[4] = 6;
		reached1[6]=1;
		((P7 *)pptr(h))->_t = 1;
		((P7 *)pptr(h))->_p = 6;
		((P7 *)pptr(h))->_n = 4; /* safety */
		src_claim = src_ln1;
#ifndef BFS
		if (whichclaim == -1 && claimname == NULL)
			printf("pan: ltl formula safety\n");
#endif
		if (whichclaim != -1)
